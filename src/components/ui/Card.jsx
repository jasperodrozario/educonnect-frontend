...
export const Room = ({ name, description, topic, host, participants, id = "1" }) => {
  return (
    <Link href={`/room/${id}`}>
      <div className="py-3 px-4 rounded-md border border-gray-2 transition-transform duration-300 hover:scale-[1.02] cursor-pointer">
